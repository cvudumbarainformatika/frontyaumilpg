        ...
        <tbody class="bg-white dark:bg-dark-800 divide-y divide-gray-200 dark:divide-gray-700">
          <tr v-for="product in products" :key="product.id" class="hover:bg-gray-50 dark:hover:bg-dark-700" v-html-safe="{
            ...
            <td class="px-6 py-4 text-sm text-gray-900 dark:text-white lg:whitespace-nowrap text-right">
              <div class="truncate"> <span class="text-gray-400">BELI :</span> {{ formatRupiah(product?.hargabeli) || 0 }}
              </div>
              <div class="truncate"><span class="text-gray-400">AMBIL :</span> {{ formatRupiah(product?.hargajual) || 0 }}
              </div>
        ...
        <div class="p-4">
          <div class="flex items-center space-x-4">
            ...
            <div class="text-right text-xs font-semibold text-gray-900 dark:text-white">
              <div class="truncate"> <span class="text-gray-400">BELI :</span> {{ formatRupiah(product?.hargabeli) }}
              </div>
              <div class="truncate"><span class="text-gray-400">AMBIL :</span> {{ formatRupiah(product?.hargajual) || 0 }}
              </div>
              <div class="truncate"><span class="text-gray-400">RUMAH :</span> {{ formatRupiah(product?.hargajualrumah) || 0 }}
